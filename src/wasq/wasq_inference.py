...
model = LlamaForCausalLM.from_pretrained(model_name, cache_dir='./', token=os.getenv('HF_TOKEN'))
...
# Load tokenizer
tokenizer = PreTrainedTokenizerFast.from_pretrained(model_name, cache_dir='./', token=os.getenv('HF_TOKEN'))
