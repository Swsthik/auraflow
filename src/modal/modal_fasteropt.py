...
def train_and_upload():
    ...
    for max_length in max_lengths:
        ...
        model = AutoModelForCausalLM.from_pretrained(model_name, cache_dir="./", token=os.getenv('HF_TOKEN'))
        ...
        for epoch in range(num_epochs):
            ...
            os.system(
                f"huggingface-cli upload aoxo/qwen2-sf4-experimental {model_path} --token=os.getenv('HF_TOKEN')"
            )
