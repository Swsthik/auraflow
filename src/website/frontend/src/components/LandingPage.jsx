      ...
      {showChat ? (
        <div className="h-screen flex flex-col">
          ...
          <button
            ...
            <h1 className="text-xl font-bold ml-2 text-gray-300">Auraflow </h1>
        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <div className="mt-32 space-y-8">
            ...
            Auraflow implements custom quantization algorithms focusing on the Lottery Ticket Hypothesis (LTH) 
              and Weight and Activation Auraflow Quantization (WASQ) techniques for optimizing neural networks 
              on edge devices.
            </p>
          </div>
          ...
          <div className="mt-16 flex justify-center space-x-6">
            <a
              href="https://github.com/YOUR_USERNAME/auraflow"
              target="_blank"
